...
public class TestDataBuild {
	...
	public String EcommerceLoginPayload(String UserID, String Password) {
		return "{\r\n"
				+ "\"userEmail\":\""+UserID+"\",\r\n"
	...
	public String EcommerceCreateOrder(String ProductOrderedId) {
		return "{\"orders\":[{\"country\":\"India\",\"productOrderedId\":\""+ProductOrderedId+"\"}]}";
	}
