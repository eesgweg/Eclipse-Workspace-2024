...
//Conversions from 1 collection to another		
//		//String Array
...
//        System.out.println(treeset);
		...
		// System.out.println(stringToInteger("122")+10);;
	...
	public static int stringToInteger(String str) {
		...
		for (char c : str.toCharArray()) {
			...
			// subtracting the ASCII value of '0' from c gives the integer value of the
			// digit
